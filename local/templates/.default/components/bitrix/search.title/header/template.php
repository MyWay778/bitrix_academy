...
<div class="header__search">
	<div class="search"  id="<?= $containerId ?>">
		<div class="search__form" data-bs-toggle="dropdown" data-bs-display="static">
...
<script>
	BX.ready(function ()
	{
		...
		// Search dropdown появление backdrop
		const myDropdown = document.getElementById("<?= $containerId ?>")
		if (myDropdown) {
